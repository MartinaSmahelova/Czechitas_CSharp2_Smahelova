...
it was the grayish white of old porridge.";
			...
			string pomlcky = "";
			string oddelovac = pomlcky.PadRight(20, '-');
			...
			//bool jeSpravneUkoncen = (text[text.Length - 1].ToString() == ".");
			...
			string[] poleBlabolu = new string[] { blabol1, blabol2, blabol3 };
			var serazene = poleBlabolu.OrderBy(item => item, StringComparer.Ordinal);

			var prvni = serazene.First();
